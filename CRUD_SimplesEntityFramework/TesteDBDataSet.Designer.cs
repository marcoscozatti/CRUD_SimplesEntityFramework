...
namespace CRUD_SimplesEntityFramework {
    ...
    public partial class TesteDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AgendaDataTable : global::System.Data.TypedTableBase<AgendaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AgendaRow AddAgendaRow(string nome, string telefone) {
...
namespace CRUD_SimplesEntityFramework.TesteDBDataSetTableAdapters {
    ...
    public partial class AgendaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Agenda] WHERE (([id] = @Original_id) AND ([nome] = @Original_n" +
                "ome) AND ([telefone] = @Original_telefone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Agenda] ([nome], [telefone]) VALUES (@nome, @telefone);\r\nSELEC" +
                "T id, nome, telefone FROM Agenda WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Agenda] SET [nome] = @nome, [telefone] = @telefone WHERE (([id] = @" +
                "Original_id) AND ([nome] = @Original_nome) AND ([telefone] = @Original_telefone)" +
                ");\r\nSELECT id, nome, telefone FROM Agenda WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_SimplesEntityFramework.Properties.Settings.Default.TesteDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, telefone FROM dbo.Agenda";
        ...
        public virtual int Fill(TesteDBDataSet.AgendaDataTable dataTable) {
        ...
        public virtual TesteDBDataSet.AgendaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TesteDBDataSet.AgendaDataTable dataTable = new TesteDBDataSet.AgendaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TesteDBDataSet.AgendaDataTable dataTable) {
